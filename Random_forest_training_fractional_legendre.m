%% main_gun_detection_FLF_RF.m
% Gun detection with Fractional-order Legendre Functions (FLF) - Random Forest
...
fprintf('Fractional Legendre Features for Weapon Detection - Random Forest\n');
fprintf('==================================================================\n');
...
fprintf('Training Random Forest classifier with FLF features...\n');
...
fprintf('\n=== FRACTIONAL LEGENDRE RANDOM FOREST RESULTS ===\n');
...
save('gun_detection_model_FLF_RF.mat', 'rf_model', 'n', 'alpha_scales', 'image_size', ...
     'train_idx', 'test_idx', 'accuracy', 'precision', 'recall', 'f1', ...
     'feature_extraction_time', 'training_time', 'time_per_image', 'memory_usage_MB');
fprintf('\nModel saved to gun_detection_model_FLF_RF.mat\n');

%% Plot confusion matrix
figure('Position', [100, 100, 600, 500]);
confusionchart(cm, {'No Gun', 'Gun'});
title(sprintf('FLF-Random Forest Confusion Matrix - Accuracy: %.2f%%', accuracy*100));