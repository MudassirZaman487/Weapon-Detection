%% main_gun_detection_FLF_KNN.m
% Gun detection with Fractional-order Legendre Functions (FLF) - k-NN
...
fprintf('Fractional Legendre Features for Weapon Detection - k-NN\n');
fprintf('=========================================================\n');
...
%% Step 4: Train k-NN
fprintf('Training k-NN classifier with FLF features...\n');
...
fprintf('\n=== FRACTIONAL LEGENDRE k-NN RESULTS ===\n');
...
save('gun_detection_model_FLF_KNN.mat', 'knn_model', 'n', 'alpha_scales', 'image_size', ...
     'train_idx', 'test_idx', 'accuracy', 'precision', 'recall', 'f1', ...
     'feature_extraction_time', 'training_time', 'time_per_image', 'memory_usage_MB');
fprintf('\nModel saved to gun_detection_model_FLF_KNN.mat\n');

%% Plot confusion matrix
figure('Position', [100, 100, 600, 500]);
confusionchart(cm, {'No Gun', 'Gun'});
title(sprintf('FLF-k-NN Confusion Matrix - Accuracy: %.2f%%', accuracy*100));